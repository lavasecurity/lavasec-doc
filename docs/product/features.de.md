...
| **Vorübergehende Pause (konfigurierbar 1–30 Min., Standard 5) + Fortsetzen** | Free | Pause/Fortsetzen laufen über `LavaProtectionCommandService` unter einem flock-Dateisperre mit Revisions-Dedup. |
