...
- **Der Soft Shield Guardian** — eine Maskottchen-Figur im Guard-Tab, in der Live Activity und in der Dynamic Island, die den Schutzzustand über 7 Ausdruckszustände zeigt. Siehe [das Designsystem](../design-system/overview.md).
