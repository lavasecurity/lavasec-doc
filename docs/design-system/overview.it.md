...
1. **Internet è lava** (`lava`) — il pericolo inquadrato come metafora; azione primaria "Meet Lava".
...
- **Pericolo inquadrato come metafora, non come paura** ("Internet è lava"), coerente con il tono calmo.
