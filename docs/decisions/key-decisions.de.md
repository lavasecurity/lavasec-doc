...
| --- | --- | --- | --- |
| 2026-08-13 | 11 `hagezi-*` | `raw.githubusercontent.com/hagezi/dns-blocklists` → `gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists` | GitHub hat das Konto `hagezi` gesperrt, wodurch jede Liste auf einen harten 404 lief. Der GitLab-Namensraum `hagezi` ist ein **Benutzer**-Namensraum, dessen Inhaber „Gerd“ ist (HaGeZis Maintainer); das Projekt entstand am 2026-04-08, Monate vor der Sperre, und trägt tägliche Commits mit Autor `hagezi` (zuletzt 2026-08-12). Alle 11 Dateien behalten Pfad und Dateinamen und liefern weiterhin ihre ursprünglichen `# Title: HaGeZi's …`-Header. |
