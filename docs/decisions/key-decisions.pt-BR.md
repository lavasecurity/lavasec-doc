...
| --- | --- | --- | --- |
| 2026-08-13 | 11 `hagezi-*` | `raw.githubusercontent.com/hagezi/dns-blocklists` → `gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists` | O GitHub bloqueou a conta `hagezi`, deixando todas as listas em 404 puro. O namespace `hagezi` no GitLab é um namespace de **usuário** cujo dono é "Gerd" (o mantenedor do HaGeZi); o projeto foi criado em 2026-04-08, meses antes do bloqueio, e traz commits diários assinados por `hagezi` (o mais recente em 2026-08-12). Os 11 arquivos mantêm caminho e nome e servem seus cabeçalhos originais `# Title: HaGeZi's …`. |
