...
| --- | --- | --- | --- |
| 2026-08-13 | 11 `hagezi-*` | `raw.githubusercontent.com/hagezi/dns-blocklists` → `gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists` | GitHub bloqueó la cuenta `hagezi`, dejando todas las listas en un 404 duro. El espacio de nombres `hagezi` de GitLab es un espacio de **usuario** cuyo propietario es «Gerd» (el mantenedor de HaGeZi); el proyecto se creó el 2026-04-08, meses antes del bloqueo, y tiene commits diarios firmados por `hagezi` (el último el 2026-08-12). Los 11 archivos conservan su ruta y su nombre y sirven sus cabeceras originales `# Title: HaGeZi's …`. |
