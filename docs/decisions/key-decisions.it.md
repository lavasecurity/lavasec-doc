...
| --- | --- | --- | --- |
| 2026-08-13 | 11 `hagezi-*` | `raw.githubusercontent.com/hagezi/dns-blocklists` → `gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists` | GitHub ha bloccato l'account `hagezi`, portando ogni lista a un 404 netto. Lo spazio dei nomi GitLab `hagezi` è uno spazio **utente** il cui proprietario è «Gerd» (il manutentore di HaGeZi); il progetto è nato il 2026-04-08, mesi prima del blocco, e riporta commit quotidiani firmati `hagezi` (l'ultimo il 2026-08-12). Tutti gli 11 file mantengono percorso e nome e servono le intestazioni originali `# Title: HaGeZi's …`. |
