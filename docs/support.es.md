...
A dónde acudir cuando necesitas ayuda, encontraste un error o quieres reportar algo.

## ¿Algo no funciona en la app?
...
El cliente iOS de Lava es de código abierto. Para preguntas técnicas, problemas de
compilación o ideas de funciones, abre un issue en
...
## Entender cómo funciona Lava

La mayoría de las preguntas del tipo "¿esto es normal?" las responde la propia documentación:

- [Resumen del producto](product/overview.md) y [Catálogo de funciones](product/features.md): qué hace Lava.
- [Filtrado DNS y listas de bloqueo](architecture/dns-filtering-and-blocklists.md): cómo se comportan el filtrado y el DNS cifrado.
- [Cuentas y respaldo de conocimiento cero](architecture/accounts-and-backup.md): qué está cifrado y qué pueden ver los servidores.
- [Decisiones clave](decisions/key-decisions.md): por qué está construido como está.
