...
## 3. Catálogo y aplicación de «solo URL de origen»
...
### 3.5 Orígenes sembrados y habilitados por defecto
...
### 4.3 Autenticación y el sobre de copia de seguridad cifrado
...
### 4.5 Reflejo de derechos del App Store
