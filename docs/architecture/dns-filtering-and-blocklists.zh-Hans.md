...
`DefaultCatalog.curatedSources` 由规范的 [Blocklist Catalog](../legal/blocklist-catalog.md) 生成，目前有 **33** 个来源，分布在七个类别：Security & Threat Intel、Multi-purpose、Ads & Trackers、Social Media、Adult Content、Gambling、Piracy & Torrent。来源家族包括 The Block List Project、Phishing.Database、HaGeZi、OISD、StevenBlack、AdGuard、1Hosts。
