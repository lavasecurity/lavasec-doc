...
### Por qué se usan mensajes de provider para el control app→túnel
...
### Selección de manager y matemática del ciclo de vida
...
### Reintento de captura de DNS del dispositivo
